...
class ItemMapperTest {
    ...
    private static final Item ITEM = Item.builder()
            ...
            .request(REQUEST)
            .build();
    private static final ItemDto DTO = ItemMapper.toItemDto(ITEM);
    ...
    void toItemDtoByRequest(ItemRequest request) {
        ItemDto dto = request == null ? ItemMapper.toItemDto(ITEM) : ItemMapper.toItemDto(ITEM, request);
    ...
    void toItemDtoByBookings(Booking lastBooking, Booking nextBooking, Set<Comment> comments) {
        ItemDto dto = lastBooking == null && nextBooking == null ?
                ...
                ItemMapper.toItemDto(ITEM, lastBooking, nextBooking, comments);
